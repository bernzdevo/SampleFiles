...
//import {DataTableDirectives} from '';
...
export class AppComponent {
  ...
  onUpload() {
    ...
    uploadedImage.append('myfile', this.selectedFile, this.selectedFile.name);
    this.http.post('http://localhost/laptopapi/laptop/image/2', uploadedImage)
      .subscribe(event => {
        console.log(event);
      });
